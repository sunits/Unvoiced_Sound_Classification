function []=train_from_timit_full(read_path, ...         % Database Path
...
%             [m1 m2 m3 m4 cross_band modPower]=getModStatistics(signal,fs,no_of_channel,modBand,fRange,modFRange);
            [m1 m2 m3 m4 m5 m6 cross_band modPower]=getModStatistics(signal,fs,no_of_channel,modBand,fRange,modFRange);
            counter=counter+1;
...
%      save(strcat(data_path,ph_to_test,data_save_path,sub_folder,'.mat'),'m1','m2','m3','m4','cross_corr','modPower');
      save(strcat(data_path,ph_to_test,data_save_path,sub_folder,'.mat'),'m1','m2','m3','m4','m5','m6','cross_corr','modPower');
