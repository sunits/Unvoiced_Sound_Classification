...
function [] = histDist_test_folder_TIMIT(ph_to_train, ...       % Which phone should I train for now?
...
%                       train_from_timit
                        counter=counter+1;
                      hist_dist_test_from_timit([data_base_path,  all_folders(index).name,'/', all_sub_folders(sub_index).name,'/'], ...
                                        base_path, ...
