...
%                 pause(0.3)
%                 plot_env_corr_no_norm
%                 plot_env_mod_power(signal,no_of_channel,fs,fRange,modFRange,modBand);
%                 plot_env_spectrogram(signal,no_of_channel,fs,fRange)
                

%% Computing the moments
           
%                 [m1(:,counter),m2(:,counter),m3(:,counter),m4(:,counter) m5(:,counter) m6(:,counter)]=plot_env_moments(signal,no_of_channel,fs,fRange,1);
