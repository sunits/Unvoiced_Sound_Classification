function [phTruth,phClassification,phAccuracy]=frameWindowingUsingStoredResults(frame, ... % Information about number of frames per phonemes
...
fprintf('\nAccuraccy from frame Windowing is %d\n',phAccuracy)