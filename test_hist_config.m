...
main_dir='/media/885C28DA5C28C532/data/TIMIT/timit/test/';
data_path='/media/885C28DA5C28C532/Dropbox/to_sunit/sunit/unvoicedCasa/TIMIT/30Channel/histogram_match/male_model/';
write_path='./';
gmm_path='';
...
histogram_base_path='/media/885C28DA5C28C532/Dropbox/to_sunit/sunit/unvoicedCasa/TIMIT/model/histogram/male/';
...
histDist_test_folder_TIMIT(ph_to_train, ...       % Which phone should I train for now?
        data_path, ...          
        feature_store_at, ...   % WHere do I store the feature?
        main_dir, ...     % path to the training part of the database
        no_of_channel, ...      % Number of filters while doing the first step decompositions
