function []=test_GMM_fast_no_LPC_full_ph(full_path, ... %
...
result(ph_index).vote_predicted=voting(class_prob,length(ph_to_train),prob_model_path,phonemes_to_compare);

acc=check_accuracy([result(ph_index).truth],[result(ph_index).vote_predicted],phonemes_to_compare);
