function []=test_GMM_MC_DCT_fast(full_path, ... %
...
%          [peaks,valleys]=lpc_based_features(tempCC(:,:,temp_index),lpc_length_peak,lpc_length_valley);
	       	...
	       	feature=dct(tempCC(:,:,temp_index),lpc_length_peak+lpc_length_valley);
        	feature=feature';
...
save([prediction_save_path 'result_16_32.mat'] ,'result','best_channels');
