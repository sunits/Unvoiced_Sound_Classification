...
mfcc_path='/home/dsplabserver/Dropbox/Sunit/to_sunit/sunit/unvoicedCasa/TIMIT/30Channel/20msec/mfcc0/Testing/';

mean_std_base_path='/home/dsplabserver/Dropbox/Sunit/to_sunit/sunit/unvoicedCasa/TIMIT/30Channel/20msec/Training/';
mean_std_path='htk_format_mfcc_stats/';
...
% 	for index=1:20
        ...
        load([cell2mat([mfcc_path, [ph_to_train(ph_index)],'/',feature_path]) strrep(all_cc(index).name,'.mat','_mfcc.mat')]);
	...
	%     TOtal number of features
        ...
        all_mfcc(moment_count).mfcc=mfcc;
	...
	% Vectorize the feature
     ...
     save_path=[base_path cell2mat(ph_to_train(ph_index)) '/htk_format_mfcc_stats/'];
...
%        
       ...
       features_for_training= [all_m1(channel,:) all_m2(channel,:) all_m3(channel,:) all_m4(channel,:) all_cross_corr(channel,:) all_mod(channel,:)];
        ...
        features_for_training=[all_mfcc' features_for_training];
