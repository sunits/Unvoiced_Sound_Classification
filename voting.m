function [pos]=voting(channel_decisions,no_of_classes,vote_path,indices,channels_to_consider)
...
for index=1:no_of_classes
	...
	final_decision(:,index)=(temp*prob_model(channels_to_consider>0,index));	
end
