function []=get_phoneme_information(read_path, ...         % Database Path
    ...
    while(1)
        ...
        if(strcmp(ph,ph_to_test))
            ...
            for frame_index=1:no_frames
                ...
                [m1 m2 m3 m4 cross_band modPower]=getModStatistics(signal((frame_index-1)*shift+1:(frame_index-1)*shift+frame_size), ...
...
%    save(strcat(data_path,ph_to_test,data_save_path,sub_folder,'.mat'),'m1','m2','m3','m4','all_phs','cross_corr','modPower');
     save(strcat(data_path,ph_to_test,data_save_path,sub_folder,'.mat'),'m1','m2','m3','m4','cross_corr','modPower','boundary');
